...
public class Controller implements Initializable {
    ...
    private void searchDegree()
    {
        ...
        String searchValue = degreeSearchField.getCharacters().toString().toUpperCase();
        int i = 0;
        int count = 0;
    ...
    public void mouseClick(MouseEvent mouseEvent) {
        ...
        if (treeView.getSelectionModel().getSelectedItem() != null) {
            ...
            if (courses.containsKey(item.getValue())) {
                ...
                creditLabel.setText(Integer.toString(courses.get(item.getValue()).getMinCredits()));
                if (!student.hasAttainment(courses.get(item.getValue()).getName())) {
        ...
        if (courseCheckBox.isSelected() && !nameLabel.getText().isEmpty()) {
            ...
            if (datePicker.getValue() == null) {
                ...
                Attainment newAttainment = new Attainment(
                    coursename, grade, credits, datePicker.getValue().toString());
    ...
    private void createTreeItems(TreeItem<String> parentItem,
        ...
        for (Entry<String, Module> mod : modules.entrySet()) {
            ...
            if (mod.getValue().getModules().size() > 0) {
                ...
                for (Entry<String, Course> cour : mod.getValue().getCourses().entrySet()) {
